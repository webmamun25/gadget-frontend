...
const Trending = ({trending}:{trending:Electronics[]}) => {
 

  const brand = trending.filter(prod => (prod.ratings>=4.8))
    ...
    <div>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 ">
        <div className="grid gap-5 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
          ...
          {
            brand.map((product, i: number) => (<div key={i} className="overflow-hidden  transition-shadow duration-300 bg-white rounded">
