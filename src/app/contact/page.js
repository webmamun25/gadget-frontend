      ...
      <div className="relative bg-gray-900">
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
            ...
            Contact Heldro - Your One-Stop Gadget Shop
              
            </h2>
            <p className="mb-6 text-base font-thin tracking-wide text-gray-300 md:text-lg">
            Have any questions about our gadgets or need help with your order? Feel free to reach out using the form below. Our friendly customer support team is here to assist you.
            </p>
            ...
            We strive to respond to all inquiries within 24 business hours. For urgent matters, you can also reach us by phone at +8801537411224 during our business hours:10AM.
            </p>
            <a
              href="/"
